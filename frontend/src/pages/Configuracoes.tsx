    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
          Parâmetros administrativos para operação, CFTV, PDFs e identidade
          visual do JetGuard.
        </p>
      </div>
      ...
      <form
        onSubmit={salvar}
        className="space-y-5 rounded-2xl bg-white p-5 shadow dark:bg-slate-900"
      >
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <label className="block">
            ...
            <input
              type="number"
              className="w-full rounded-lg border p-3 dark:border-slate-700 dark:bg-slate-950 dark:text-white"
              placeholder="Percentual mínimo esperado de disponibilidade"
          ...
          <label className="block">
            <span className="mb-2 block text-sm font-semibold text-slate-700 dark:text-slate-200">
              Tempo máximo offline (minutos)
            </span>
            <input
              type="number"
              className="w-full rounded-lg border p-3 dark:border-slate-700 dark:bg-slate-950 dark:text-white"
              placeholder="Tempo limite de cÃ¢mera offline em minutos"
              value={form.tempoMaximoOffline}
              onChange={(e) => campo("tempoMaximoOffline", e.target.value)}
            />
          </label>
          <label className="block">
            <span className="mb-2 block text-sm font-semibold text-slate-700 dark:text-slate-200">
              Periodicidade checklist CFTV (dias)
            </span>
            <input
              type="number"
              className="w-full rounded-lg border p-3 dark:border-slate-700 dark:bg-slate-950 dark:text-white"
              placeholder="Intervalo obrigatório entre checklists"
              value={form.checklistCameraDias}
              onChange={(e) => campo("checklistCameraDias", e.target.value)}
            />
          </label>
          <label className="block">
            <span className="mb-2 block text-sm font-semibold text-slate-700 dark:text-slate-200">
        ...
        <button
          disabled={salvando}
          className="rounded-lg bg-blue-600 px-5 py-3 font-bold text-white disabled:bg-slate-400"
        >
