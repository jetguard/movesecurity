...
export default function Financeiro() {
  ...
  const [conta, setConta] = useState({ nome: "", ano: String(new Date().getFullYear()), valorOrcado: "", observacoes: "", status: "ATIVO" });
