...
const secoes: SecaoTreinamento[] = [
  {
    ...
    pontos: [
      "Evento é um fato que pode comprometer a segurança física, patrimonial, operacional ou de pessoas no terminal.",
      "Ocorrência é a materialização de evento ou sequência de eventos que gera desvio, impacto real ou potencial e exige registro e tratamento.",
      "Investigação é o conjunto de atos metodológicos, técnicos e analíticos para esclarecer dinâmica, autoria, materialidade, causas e vulnerabilidades.",
  ...
  },
  {
    ...
    responsabilidades: [
      ...
      "Líder de Segurança acompanha ocorrências críticas, valida evidências, tipifica relatórios e distribui documentação.",
      "Supervisor e Coordenador analisam eventos de maior risco, conduzem investigações complexas e propõem melhorias.",
    ],
    pontos: [
      "O CFTV atua de forma preventiva e em tempo real.",
      "O Assistente de Segurança consolida informações iniciais e evidências.",
  ...
  },
  {
    ...
    responsabilidades: [
      ...
      "Aplicar formulários corporativos quando necessário, como relato individual, atendimento interno e RCA.",
    ],
    pontos: [
      "Evento gera RE quando houver registro informativo ou situação potencial.",
      "Ocorrência gera RO quando há desvio materializado, impacto real ou potencial e necessidade de tratamento.",
      "Investigação gera RI quando há necessidade de elucidar dinâmica, autoria, materialidade, causas e vulnerabilidades.",
  ...
  },
  {
    ...
    responsabilidades: [
      ...
      "Direcionar o relatório aos responsáveis e conduzir causa raiz em RI conforme procedimento aplicável.",
    ],
    pontos: [
      "A identificação deve seguir o POC-SEP-002 quando envolver monitoramento.",
  ...
  },
  {
    ...
    responsabilidades: [
      ...
      "Acionar recursos como Manutenção, Segurança do Trabalho, Brigada, Polícia Militar, Polícia Federal, Bombeiros, Receita Federal, Guarda Portuária ou outros conforme gravidade.",
    ],
    pontos: [
      "A comunicação rápida reduz riscos e melhora a resposta.",
  ...
  },
  {
    ...
    responsabilidades: [
      ...
      "Anexar registro fotográfico quando aplicável e formalizar assinatura.",
    ],
    pontos: [
      "Pessoas envolvidas podem ser classificadas como Vítima, Infrator, Denunciante, Testemunha ou Solicitante.",
  ...
  },
  {
    ...
    pontos: [
      "P1 Crítica / Emergencial envolve ameaça imediata à vida, alto valor, interrupção total das operações ou infraestrutura crítica.",
      "P2 Alta / Severa envolve danos significativos ao patrimônio ou violações graves de perímetro sem vitimação.",
  ...
  },
  {
    ...
    responsabilidades: [
      ...
      "Alta / Severa: acionar Supervisor, Coordenador Regional e coordenadores ou supervisores dos departamentos envolvidos.",
      "Crítica / Emergencial: acionar Coordenador Regional, Gerente de Segurança Corporativo e demais lideranças aplicáveis.",
    ],
    pontos: [
      "O encaminhamento pode envolver órgãos, autoridades ou Plano de Auxílio Mútuo.",
  ...
  },
  {
    ...
    responsabilidades: [
      ...
      "Arquivar RE, RO e RI em pasta ou sistema controlado pela gestão de Segurança Patrimonial.",
    ],
    pontos: [
      "Gestores assumem accountability pelas tratativas após o encaminhamento.",
  ...
  },
  {
    ...
    responsabilidades: [
      ...
      "Controlar valores de perda e valores recuperados conforme procedimento aplicável.",
      "Avaliar reincidência por tipo, áreas de maior ocorrência e estatísticas por região.",
    ],
    pontos: [
      "Indicadores apoiam análise de performance e melhoria contínua.",
  ...
  },
  {
    ...
    responsabilidades: [
      ...
      "Contribuir para melhoria contínua e mitigação de riscos.",
    ],
    pontos: [
      "O procedimento fortalece a resposta corporativa a eventos e ocorrências.",
...
const quizBase: PerguntaQuiz[] = [
  ...
  {
    pergunta: "Qual sigla representa Relatório de Ocorrência?",
    opcoes: ["RO", "RE", "RI", "RCA"],
    correta: 0,
  },
  {
