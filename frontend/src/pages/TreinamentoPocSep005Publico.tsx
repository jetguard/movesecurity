...
const secoes: SecaoTreinamento[] = [
  {
    numero: "5.1",
    titulo: "Fluxo de escaneamento",
    objetivo: "Apresentar o fluxo de escaneamento nas unidades Movecta.",
    resumo:
      "No T1 Guarujá, todos os contêineres que acessam o terminal passam por escaneamento devido à posição do equipamento após a balança de entrada.",
    responsabilidades: [
      "Acompanhar parametrizações no sistema Novvs.",
      "Direcionar unidades de importação do T2 Guarujá ao T1 quando houver obrigatoriedade.",
      "Cumprir definições aplicáveis à operação do scanner.",
    ],
    pontos: [
      "Unidades definidas para scanner são demonstradas no Novvs.",
      "Contêineres de importação do T2 podem passar pelo scanner no T1.",
      "O fluxo apoia conformidade aduaneira.",
    ],
    atencao:
      "O escaneamento é condicionante de segurança e conformidade com requisitos da Receita Federal.",
  },
  {
    numero: "5.2",
    titulo: "Monitoramento de contêineres",
    objetivo: "Orientar monitoramento de contêineres no sistema Novvs.",
    resumo:
      "Segurança Patrimonial e Processos Aduaneiros monitoram contêineres de importação e exportação e notificam Operações sobre pendências de escaneamento.",
    responsabilidades: [
      "Monitorar pendências de escaneamento.",
      "Notificar o setor Operacional quando houver pendência.",
      "Informar exceções de Flat Rack e Open Top ao COV via Processos Aduaneiros.",
    ],
    pontos: [
      "A conformidade observa a Portaria nº 119 da ALF/STS.",
      "Flat Rack e Open Top com excesso acima de 30 cm podem ser dispensados conforme acordo.",
      "Exceções devem ser comunicadas pelo fluxo definido.",
    ],
    atencao:
      "Pendências de escaneamento devem ser tratadas para manter conformidade.",
  },
  {
    numero: "5.3",
    titulo: "Análise das imagens escaneadas",
    objetivo: "Explicar a análise de imagens de raio-X.",
    resumo:
      "O Inspetor de Imagem/Carga analisa imagens para identificar anormalidades e áreas suspeitas usando critérios de peso atômico, densidade e colorações.",
    responsabilidades: [
      "Analisar imagens para detectar anormalidades.",
      "Liberar imagens dentro dos padrões no sistema operacional.",
      "Reportar anormalidades a Processos Aduaneiros e Segurança Patrimonial.",
    ],
    pontos: [
      "Cores indicam orgânicos, mistos e inorgânicos.",
      "Status CHEIO ou VAZIO deve ser conferido com Novvs e imagem.",
      "Divergências devem ser comunicadas imediatamente por e-mail com número do contêiner.",
    ],
    atencao:
      "O tempo de análise do Inspetor é inegociável e não deve sofrer interferência.",
  },
  {
    numero: "5.4",
    titulo: "Diretório da Receita Federal",
    objetivo:
      "Definir disponibilidade e qualidade das imagens para Receita Federal.",
    resumo:
      "As imagens devem estar disponíveis com qualidade satisfatória no Diretório Movecta na mesma data do escaneamento e migrar diariamente para a pasta Scanner.",
    responsabilidades: [
      "Garantir qualidade satisfatória das imagens.",
      "Solicitar retorno do caminhão quando a imagem não atender padrões.",
      "Regularizar pendências de migração automática no Novvs com a prestadora.",
    ],
    pontos: [
      "Imagem insatisfatória exige retorno ao canal de inspeção.",
      "Processos Aduaneiros identifica pendências no Novvs.",
      "A prestadora deve regularizar imagens pendentes.",
    ],
    atencao:
      "Imagem pendente ou sem qualidade pode comprometer conformidade com a Receita Federal.",
  },
  {
    numero: "5.5",
    titulo: "Área suspeita no primeiro escaneamento",
    objetivo: "Definir comunicação de área suspeita no primeiro escaneamento.",
    resumo:
      "Toda unidade identificada com área suspeita pela prestadora deve ser informada a Segurança Patrimonial e Processos Aduaneiros por e-mail.",
    responsabilidades: [
      "Informar contêineres cheios e vazios com área suspeita.",
      "Abranger fluxos de importação e exportação.",
      "Anexar imagem extraída diretamente do sistema de análise.",
    ],
    pontos: [
      "A comunicação deve conter nomenclatura da unidade.",
      "A imagem deve seguir anexada.",
      "A comunicação ocorre durante o turno quando identificada.",
    ],
    atencao:
      "Toda área suspeita deve ser comunicada formalmente e com evidência.",
  },
  {
    numero: "5.6",
    titulo: "Segundo escaneamento em rotas críticas",
    objetivo:
      "Orientar o segundo escaneamento de exportação para rotas críticas.",
    resumo:
      "O segundo escaneamento compara dados de imagem da origem e destino para identificar discrepâncias durante armazenamento, conforme análise de risco e destino.",
    responsabilidades: [
      "Acompanhar programação de recebimento e destino.",
      "Implementar ações antes do contêiner deixar o terminal.",
      "Fiscalizar armazenamento e entrega conforme portarias aplicáveis.",
    ],
    pontos: [
      "Transporte e Planejamento apoiam com programação de cargas de rotas críticas.",
      "Novvs apoia detalhamento e posicionamento das unidades.",
      "Receita Federal decide sobre ações potenciais em imagens suspeitas.",
    ],
    atencao:
      "A comunicação de imagens suspeitas à Receita Federal cabe a Processos Aduaneiros.",
  },
  {
    numero: "5.7",
    titulo: "Relatório de passagem de serviço",
    objetivo: "Padronizar relatório de inspeção por turno.",
    resumo:
      "A empresa responsável pela operação de scanner envia relatório de inspeção no término de cada turno para Segurança Patrimonial e Processos Aduaneiros.",
    responsabilidades: [
      "Enviar informações ocorridas no turno.",
      "Respeitar escalas e períodos operacionais definidos.",
      "Encaminhar relatório à gestão dos departamentos responsáveis.",
    ],
    pontos: [
      "Sudeste opera em escala 12x36 com turnos 07:00-19:00 e 19:00-07:00.",
      "Nordeste opera em escala 6x1 em turnos definidos.",
      "O relatório registra a passagem de serviço.",
    ],
    atencao:
      "A passagem de serviço mantém continuidade e rastreabilidade da operação.",
  },
  {
    numero: "5.8",
    titulo: "Ausência da prestadora",
    objetivo: "Definir tratativa em ausência da empresa contratada.",
    resumo:
      "Em ausência de membros das equipes contratadas, cabe à própria empresa providenciar cobertura para não impactar as operações Movecta.",
    responsabilidades: [
      "Identificar ausência de equipe contratada.",
      "Acionar cobertura pela própria prestadora.",
      "Evitar impacto às operações Movecta.",
    ],
    pontos: [
      "A responsabilidade de cobertura é da prestadora.",
      "A ausência não deve interromper a operação.",
      "A gestão deve acompanhar a reposição.",
    ],
    atencao:
      "A operação de scanner não deve ser impactada por ausência de equipe contratada.",
  },
];

const quizBase: PerguntaQuiz[] = [
  {
    pergunta: "Qual é o foco da etapa 5.1 - Fluxo de escaneamento?",
    opcoes: [
      "Apresentar o fluxo de escaneamento nas unidades Movecta.",
  ...
  {
    pergunta: "Na etapa Fluxo de escaneamento, qual ponto deve ser observado?",
    opcoes: [
      "Unidades definidas para scanner são demonstradas no Novvs.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.2 - Monitoramento de contêineres?",
    opcoes: [
      "Orientar monitoramento de contêineres no sistema Novvs.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
  ...
  {
    pergunta:
      "Na etapa Monitoramento de contêineres, qual ponto deve ser observado?",
    opcoes: [
      "A conformidade observa a Portaria nº 119 da ALF/STS.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.3 - Análise das imagens escaneadas?",
    opcoes: [
      "Explicar a análise de imagens de raio-X.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
  ...
  {
    pergunta:
      "Na etapa Análise das imagens escaneadas, qual ponto deve ser observado?",
    opcoes: [
      "Cores indicam orgânicos, mistos e inorgânicos.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.4 - Diretório da Receita Federal?",
    opcoes: [
      "Definir disponibilidade e qualidade das imagens para Receita Federal.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta:
      "Na etapa Diretório da Receita Federal, qual ponto deve ser observado?",
    opcoes: [
      "Imagem insatisfatória exige retorno ao canal de inspeção.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta:
      "Qual é o foco da etapa 5.5 - Área suspeita no primeiro escaneamento?",
    opcoes: [
      "Definir comunicação de área suspeita no primeiro escaneamento.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
  ...
  {
    pergunta:
      "Na etapa Área suspeita no primeiro escaneamento, qual ponto deve ser observado?",
    opcoes: [
      "A comunicação deve conter nomenclatura da unidade.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta:
      "Qual é o foco da etapa 5.6 - Segundo escaneamento em rotas críticas?",
    opcoes: [
      "Orientar o segundo escaneamento de exportação para rotas críticas.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta:
      "Na etapa Segundo escaneamento em rotas críticas, qual ponto deve ser observado?",
    opcoes: [
      "Transporte e Planejamento apoiam com programação de cargas de rotas críticas.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.7 - Relatório de passagem de serviço?",
    opcoes: [
      "Padronizar relatório de inspeção por turno.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
  ...
  {
    pergunta:
      "Na etapa Relatório de passagem de serviço, qual ponto deve ser observado?",
    opcoes: [
      "Sudeste opera em escala 12x36 com turnos 07:00-19:00 e 19:00-07:00.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.8 - Ausência da prestadora?",
    opcoes: [
      "Definir tratativa em ausência da empresa contratada.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
...
export default function TreinamentoPocSep005Publico() {
  ...
  useEffect(() => {
    axios
      .get("/api/public/treinamento-poc-sep-005/unidades")
      .then((response) => {
  ...
  async function buscarCadastro(identificador: string) {
    ...
    try {
      const response = await axios.get(
        "/api/public/treinamento-poc-sep-005/participante",
        {
  ...
  async function iniciar(event: FormEvent) {
    ...
    try {
      const response = await axios.post(
        "/api/public/treinamento-poc-sep-005/iniciar",
        form,
      );
  ...
  async function concluirEtapaAtual() {
    ...
    try {
      const response = await axios.put(
        `/api/public/treinamento-poc-sep-005/${treinamento.token}/etapa`,
        {
          etapa: indiceSecao + 1,
        },
      );
  ...
  async function validarQuiz() {
    ...
    try {
      ...
      const response = await axios.post(
        `/api/public/treinamento-poc-sep-005/${treinamento.token}/quiz`,
        {
  ...
  async function concluirComAssinatura() {
    ...
    try {
      const response = await axios.post(
        `/api/public/treinamento-poc-sep-005/${treinamento.token}/concluir`,
        {
      ...
      <section className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col px-3 py-5 sm:px-6 sm:py-8 lg:px-8">
        <div className="terminal-panel mb-5 flex items-center justify-between gap-4 rounded-2xl border px-4 py-3 shadow-xl sm:mb-8 sm:px-5 sm:py-4">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-black tracking-tight sm:text-3xl">
              Operação de Escaneamento de Contêineres
            </h1>
          </div>
        ...
        {treinamento && (
          <div className="mb-5 grid grid-cols-2 gap-3 lg:grid-cols-4">
            ...
            <button
              type="button"
              disabled={(treinamento?.etapaAtual || 1) < 9}
          ...
          <div className="terminal-panel rounded-2xl border p-4 shadow-2xl sm:p-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-black">Quiz POC-SEP-005</h2>
