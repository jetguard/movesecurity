...
const secoes: SecaoTreinamento[] = [
  {
    numero: "5",
    titulo: "Descrição",
    objetivo: "Orientar o recebimento e tratamento de informações e informes.",
    resumo:
      "A Segurança Patrimonial pode receber informações por flagrante, HT, ligação interna, aplicativo de mensagem, meios oficiais, e-mail, Teams ou canal de denúncia.",
    responsabilidades: [
      "Reportar as informações à liderança de Segurança Patrimonial.",
      "Validar o conteúdo recebido antes das tratativas.",
      "Preservar sigilo, confidencialidade, integridade, disponibilidade e autenticidade.",
    ],
    pontos: [
      "Denúncias anônimas devem usar o FC-2237 com o máximo de detalhes.",
      "Após validação, inicia-se apuração e relatório de investigação quando aplicável.",
      "Ocorrências podem evoluir para Relatório de Investigação conforme natureza.",
    ],
    atencao:
      "O sigilo dos informes é condição indispensável para proteger fontes e a organização.",
  },
  {
    numero: "5.1",
    titulo: "Definição de importância",
    objetivo: "Definir o grau de importância das informações recebidas.",
    resumo:
      "As ameaças identificadas devem ter seu grau de importância definido por análise de risco para orientar as tratativas necessárias.",
    responsabilidades: [
      "Avaliar consequências potenciais da concretização das informações.",
      "Definir importância com base em análise de risco.",
      "Encaminhar tratativas conforme criticidade.",
    ],
    pontos: [
      "Consequências podem ser imensuráveis.",
      "A análise de risco direciona prioridades.",
      "A liderança valida o conteúdo antes da sequência das ações.",
    ],
    atencao: "Não trate informações sensíveis sem avaliar sua criticidade.",
  },
  {
    numero: "5.2",
    titulo: "Métodos e aplicações",
    objetivo: "Apresentar ferramentas usadas na investigação.",
    resumo:
      "O procedimento orienta o uso de métodos como 5 Porquês, 5W2H e Matriz SWOT no planejamento, execução e relatório da investigação.",
    responsabilidades: [
      "Aplicar método adequado ao tipo de apuração.",
      "Usar ferramentas para estruturar causas, plano de ação e riscos.",
      "Manter evidências válidas e rastreáveis.",
    ],
    pontos: [
      "Métodos organizam a investigação e evitam conclusões frágeis.",
      "O uso correto apoia decisões administrativas.",
      "A ferramenta escolhida deve servir ao esclarecimento dos fatos.",
    ],
    atencao:
      "Método sem evidência não sustenta decisão; evidência sem método perde força.",
  },
  {
    numero: "5.2.1",
    titulo: "Os 5 Porquês",
    objetivo: "Explicar o uso dos 5 Porquês para análise de causa raiz.",
    resumo:
      "O método busca chegar à origem do problema e impedir que a investigação pare em uma causa aparente ou bode expiatório.",
    responsabilidades: [
      "Perguntar sucessivamente por que o controle falhou.",
      "Buscar causa raiz antes de concluir responsabilidades.",
      "Aplicar em casos como desvio de estoque ou falha de controle.",
    ],
    pontos: [
      "Ajuda a entender por que o fato ocorreu.",
      "Evita parar no primeiro culpado aparente.",
      "Contribui para corrigir controles vulneráveis.",
    ],
    atencao:
      "A investigação deve chegar à causa raiz, não apenas ao efeito visível.",
  },
  {
    numero: "5.3",
    titulo: "5W2H",
    objetivo: "Organizar plano de ação e execução da investigação.",
    resumo:
      "Após identificar culpado ou falha, o 5W2H organiza o que será feito para coletar provas ou corrigir danos.",
    responsabilidades: [
      "Definir o que será investigado.",
      "Definir por que, quem, onde, quando, como e quanto custa.",
      "Planejar cronograma para evitar prescrição.",
    ],
    pontos: [
      "What define o objeto investigado.",
      "Why define o indício ou motivo.",
      "Who, Where, When, How e How Much estruturam execução e custo.",
    ],
    atencao:
      "Sem plano de ação, a investigação pode perder prazo, foco e evidência.",
  },
  {
    numero: "5.4",
    titulo: "Matriz SWOT",
    objetivo: "Aplicar SWOT ao planejamento de risco da investigação.",
    resumo:
      "A matriz SWOT é usada para avaliar forças, fraquezas, oportunidades e ameaças da própria investigação.",
    responsabilidades: [
      "Avaliar robustez de provas digitais.",
      "Analisar influência de suspeitos e riscos externos.",
      "Usar o caso para melhoria de compliance quando aplicável.",
    ],
    pontos: [
      "Forças: provas digitais robustas.",
      "Fraquezas: suspeito em cargo influente.",
      "Ameaças: vazamento para imprensa ou processo trabalhista.",
    ],
    atencao:
      "A SWOT deve apoiar o relatório final e sugerir melhorias estratégicas.",
  },
  {
    numero: "5.5",
    titulo: "Conclusão",
    objetivo: "Reforçar neutralidade, sigilo e validade das evidências.",
    resumo:
      "A aplicação rigorosa garante apurações com neutralidade, sigilo e integridade, servindo de base para decisões administrativas e medidas disciplinares quando cabíveis.",
    responsabilidades: [
      "Conduzir apuração com neutralidade.",
      "Preservar sigilo e integridade dos envolvidos.",
      "Transformar cada investigação em diagnóstico de vulnerabilidades.",
    ],
    pontos: [
      "O relatório final deve ser auditável e resistente a questionamentos jurídicos.",
      "Métodos padronizados fortalecem validade das evidências.",
      "Dados consolidados alimentam melhoria dos controles internos.",
    ],
    atencao:
      "A investigação deve buscar a verdade real e fortalecer a cultura de transparência.",
  },
];
...
const quizBase: PerguntaQuiz[] = [
  {
    ...
    opcoes: [
      "Orientar o recebimento e tratamento de informações e informes.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.1 - Definição de importância?",
    opcoes: [
      "Definir o grau de importância das informações recebidas.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
  ...
  {
    pergunta:
      "Na etapa Definição de importância, qual ponto deve ser observado?",
    opcoes: [
      "Consequências podem ser imensuráveis.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.2 - Métodos e aplicações?",
    opcoes: [
      "Apresentar ferramentas usadas na investigação.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
  ...
  {
    pergunta: "Na etapa Métodos e aplicações, qual ponto deve ser observado?",
    opcoes: [
      "Métodos organizam a investigação e evitam conclusões frágeis.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.2.1 - Os 5 Porquês?",
    opcoes: [
      "Explicar o uso dos 5 Porquês para análise de causa raiz.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
  ...
  {
    pergunta: "Na etapa Os 5 Porquês, qual ponto deve ser observado?",
    opcoes: [
      "Ajuda a entender por que o fato ocorreu.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.3 - 5W2H?",
    opcoes: [
      "Organizar plano de ação e execução da investigação.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
  ...
  {
    pergunta: "Na etapa 5W2H, qual ponto deve ser observado?",
    opcoes: [
      "What define o objeto investigado.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.4 - Matriz SWOT?",
    opcoes: [
      "Aplicar SWOT ao planejamento de risco da investigação.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
  ...
  {
    pergunta: "Na etapa Matriz SWOT, qual ponto deve ser observado?",
    opcoes: [
      "Forças: provas digitais robustas.",
      "Ação opcional sem necessidade de evidências.",
      "Somente acompanhamento financeiro do contrato.",
  ...
  {
    pergunta: "Qual é o foco da etapa 5.5 - Conclusão?",
    opcoes: [
      "Reforçar neutralidade, sigilo e validade das evidências.",
      "Apenas comunicação informal sem registro.",
      "Somente acompanhamento financeiro do contrato.",
      "Atividade sem relação com segurança patrimonial.",
    ],
...
export default function TreinamentoPocSep003Publico() {
  ...
  useEffect(() => {
    axios
      .get("/api/public/treinamento-poc-sep-003/unidades")
      .then((response) => {
  ...
  async function buscarCadastro(identificador: string) {
    ...
    try {
      const response = await axios.get(
        "/api/public/treinamento-poc-sep-003/participante",
        {
  ...
  async function iniciar(event: FormEvent) {
    ...
    try {
      const response = await axios.post(
        "/api/public/treinamento-poc-sep-003/iniciar",
        form,
      );
  ...
  async function concluirEtapaAtual() {
    ...
    try {
      const response = await axios.put(
        `/api/public/treinamento-poc-sep-003/${treinamento.token}/etapa`,
        {
          etapa: indiceSecao + 1,
        },
      );
  ...
  async function validarQuiz() {
    ...
    try {
      ...
      const response = await axios.post(
        `/api/public/treinamento-poc-sep-003/${treinamento.token}/quiz`,
        {
  ...
  async function concluirComAssinatura() {
    ...
    try {
      const response = await axios.post(
        `/api/public/treinamento-poc-sep-003/${treinamento.token}/concluir`,
        {
          ...
          <div className="terminal-panel rounded-2xl border p-4 shadow-2xl sm:p-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-black">Quiz POC-SEP-003</h2>
