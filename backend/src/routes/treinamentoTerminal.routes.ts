...
router.post(
  "/public/treinamento-terminal/:token/concluir",
  concluirTreinamentoTerminal,
);
router.get(
  "/public/treinamento-terminal/:token/certificado",
  baixarCertificadoTreinamento,
);
router.get(
  "/public/treinamento-terminal/:token/validar",
  validarCertificadoTreinamento,
);
router.get(
...
router.post(
  "/treinamentos-terminal/:id/reenviar-certificado",
  autenticarUsuario,
  autorizarPerfis(acessoTreinamentosTerminal),
  reenviarCertificadoTreinamento,
);
router.delete(
  "/treinamentos-terminal/:id",
  autenticarUsuario,
