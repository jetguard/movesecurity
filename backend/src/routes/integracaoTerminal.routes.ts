...
import { acessoIntegracoesTerminal, acessoTotal, autenticarUsuario, autorizarPerfis } from "../middlewares/auth";
...
router.get("/integracoes-do-terminal", autenticarUsuario, autorizarPerfis(acessoIntegracoesTerminal), listarIntegracoesTerminal);
