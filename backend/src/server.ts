...
import indicadoresSegurancaEmpresarialRoutes from "./routes/indicadoresSegurancaEmpresarial.routes";
...
import painelTreinamentosRoutes from "./routes/painelTreinamentos.routes";
...
app.use("/api/indicadores-seguranca-empresarial", indicadoresSegurancaEmpresarialRoutes);
...
app.use("/api/painel-treinamentos", painelTreinamentosRoutes);
